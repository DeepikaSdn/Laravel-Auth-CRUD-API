...
<div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
        ...
        <!-- Nav Item - Categories -->
        <li class="nav-item @if(!Request::is('admin.categories*')) collapsed @endif">
        ...
        <!-- Nav Item - Products -->
        <li class="nav-item {{ route('admin.profile') ? 'active' : '' }}">
        ...
        <!-- Nav Item - Categories -->
        <li class="nav-item {{ route('admin.about') ? 'active' : '' }}">
